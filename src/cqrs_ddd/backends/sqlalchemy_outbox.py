...
class SQLAlchemyOutboxStorage(OutboxStorage):
    ...
    async def get_pending(self, batch_size: int = 50, unit_of_work: Any = None) -> List[AbstractOutboxMessage]:
        ...
        async def _query(session):
            ...
            lock_clause = " FOR UPDATE SKIP LOCKED" if self._supports_skip_locked else ""
