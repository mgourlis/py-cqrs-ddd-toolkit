...
from typing import Optional, Callable, Any, List, Union, Type, TYPE_CHECKING, TypeVar, Generic

try:
    from sqlalchemy.ext.asyncio import AsyncSession, async_sessionmaker, AsyncEngine
    from sqlalchemy import select, Column, DateTime, String, Integer, Boolean
    ...
    Mapped = Any
    mapped_column = Any
    declarative_mixin = lambda x: x

from ..persistence_dispatcher import OperationPersistence, QueryPersistence, RetrievalPersistence
from ..exceptions import ConcurrencyError, EntityNotFoundError

if TYPE_CHECKING:
    from ..ddd import Modification
    ...
    async def check_version(
        ...
        if db_entity and hasattr(db_entity, 'version'):
            ...
            if db_entity.version != expected_version:
                raise ConcurrencyError(expected=expected_version, actual=db_entity.version)
