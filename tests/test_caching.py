...
async def test_invalidate_decorator():
    ...
    key_builder = lambda f, arg: f"key:{arg}"
...
async def test_invalidate_exception():
    ...
    @cache_invalidate(key_builder=lambda f: "k", cache_service_provider=lambda: bad_service)
    async def func():
        return "ok"
