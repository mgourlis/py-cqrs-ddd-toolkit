...
def clean_registries():
    ...
    # Restore
    _modification_handlers.clear(); _modification_handlers.update(orig_mod)
    _retrieval_handlers.clear(); _retrieval_handlers.update(orig_ret)
    _query_handlers.clear(); _query_handlers.update(orig_qry)
