...
import cqrs_ddd.backends.redis_cache as redis_cache_mod  # noqa: E402
from cqrs_ddd.backends.redis_cache import RedisCacheService  # noqa: E402
...
async def test_redis_cache_batch(mock_redis, monkeypatch):
    ...
    # set_batch
    entries = [{"cache_key": "k1", "value": "v1"}, {"cache_key": "k2", "value": "v2"}]
    ...
    # get_batch
    mock_redis.mget.return_value = [zlib.compress(pickle.dumps("v1")), None, b"corrupt"]
