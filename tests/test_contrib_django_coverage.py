...
async def test_cqrs_view_mediator_branches():
    ...
    view_empty = CQRSView()
    with pytest.raises(
        RuntimeError, match="requires either 'container' or '_mediator'"
    ):
...
@pytest.mark.filterwarnings(
    "ignore:coroutine 'AsyncMock.*' was never awaited:RuntimeWarning"
)
